...
export const words = [
  {
    englishWord: "QR CODE",
    hausaWord: "QR CODE",
    description: "Wannan wani tsararren alama ne da ke ƙunshe da bayanai daban-daban wanda ake karanta shi da kyamarar waya. Sanannen siffar alamar QR Code wasu tarin baƙaken ɗigogi ne masu girma daban-daban.",
    folderPath: "QR_CODE",
    image:"image.png",
    audio1: "audio1",
    audio2: "audio2",
...
export default function Q({ navigation }): JSX.Element {
