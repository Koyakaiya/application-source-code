    ...
    return(
        ...
        style={styles.img}>
            <View style={styles.container}>
                ...
                <View style={{flexDirection:'row', justifyContent:'space-between', width:'80%', marginHorizontal:'5%'}}>
                    <TouchableOpacity
                ...
                <Text style={{fontSize:24, fontFamily:'Inter-Bold', color:'#2468AB'}}>Privacy & Security</Text>
                </View>
                </View>
            <View style={{
                    width: '100%',
