...
import dings from '../audio/FIREWALL/FIREWALL1.mp3';
import dings2 from '../audio/FIREWALL/FIREWALL2.mp3';
import dings3 from '../audio/FIREWALL/FIREWALL3.mp3';
import firewallimg from '../audio/FIREWALL/firewall.png';
...
export default function Firewall({ navigation }): JSX.Element {
        ...
        <View style={styles.SBFcontainer}>
          ...
          <View style={styles.audiodetailsContainer}>
            <View style={styles.detailsname}>
              ...
              <Text style={styles.engtranslationtext}>Firewall</Text>
            </View>
            {/* Audio */}
          ...
          <View style={styles.audiodetailsContainer}>
            <View style={styles.detailsname}>
              ...
              <Text style={styles.engtranslationtext}>Makarin Zabi</Text>
            </View>
            {/* Audio */}
            <View style={styles.audioContainer}>
            <TouchableOpacity
          ...
          <View style={styles.explanation}>
            ...
            <View style={styles.description}>
              ...
              Wannan wani maƙarin tsare kowane mahaɗar yanar gizo ne da ke sa ido da kuma tace cibiyar sadarwa daga bayanai masu shigowa da masu fita. Hukumomi ko ɗaiɗaikun masu amfani da mahaɗar yanar gizo zasu iya kunna makarin nan bisa zaɓi.
              </Text>
            </View>
          </View>
          {/* GIF, Images, Video */}
          <View style={styles.givcontainer}>
            ...
            <Image source={firewallimg} style={styles.imgorgif}/>
            </View>
          </View>
        </View>
      </ImageBackground>
