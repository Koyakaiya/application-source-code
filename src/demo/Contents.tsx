...
import dings from '../audio/CONTENTS/CONTENTS1.mp3';
import dings2 from '../audio/CONTENTS/CONTENTS2.mp3';
import dings3 from '../audio/CONTENTS/CONTENTS3.mp3';
import Ionicons from 'react-native-vector-icons/Ionicons';
import contentimg from '../audio/CONTENTS/contents.png'
...
export default function Contents({ navigation }): JSX.Element {
        ...
        <View style={styles.SBFcontainer}>
          ...
          <View style={styles.audiodetailsContainer}>
            <View style={styles.detailsname}>
              ...
              <Text style={styles.engtranslationtext}>Contents</Text>
            </View>
            {/* Audio */}
          ...
          <View style={styles.audiodetailsContainer}>
            <View style={styles.detailsname}>
              ...
              <Text style={styles.engtranslationtext}>Ƙunshi</Text>
            </View>
            {/* Audio */}
            <View style={styles.audioContainer}>
            <TouchableOpacity
          ...
          <View style={styles.explanation}>
            ...
            <View style={styles.description}>
              ...
              Wannan shi ne duk wani abin da yake cikin wani bayani ko littafi.
              </Text>
            </View>
          </View>
          {/* GIF, Images, Video */}
          <View style={styles.givcontainer}>
            ...
            <View style={styles.diagramcontainer}>
                <Image source={contentimg} style={styles.imgorgif}/>
            </View>
          </View>
        </View>
      </ImageBackground>
