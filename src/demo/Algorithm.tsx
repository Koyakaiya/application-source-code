...
import dings from '../audio/ALGORITHM/ALGORITHM1.mp3';
import dings2 from '../audio/ALGORITHM/ALGORITHM2.mp3';
import dings3 from '../audio/ALGORITHM/ALGORITHM3.mp3';
import algooimg from '../audio/ALGORITHM/algorithm.gif'
...
export default function Algorithm({ navigation }): JSX.Element {
        ...
        <View style={styles.SBFcontainer}>
          ...
          <View style={styles.audiodetailsContainer}>
            <View style={styles.detailsname}>
              ...
              <Text style={styles.engtranslationtext}>Algorithm</Text>
            </View>
            {/* Audio */}
          ...
          <View style={styles.audiodetailsContainer}>
            <View style={styles.detailsname}>
              ...
              <Text style={styles.engtranslationtext}>Ka'Idojin Lissafi</Text>
            </View>
            {/* Audio */}
            <View style={styles.audioContainer}>
            <TouchableOpacity
          ...
          <View style={styles.explanation}>
            ...
            <View style={styles.description}>
              ...
              Wannan shi ne tsarin ka’idoji na musamman da ke ba wa na’ura ko manhaja damar cika buƙatar mai amfani da shi.
              </Text>
            </View>
          </View>
          {/* GIF, Images, Video */}
          <View style={styles.givcontainer}>
            ...
            <View style={styles.diagramcontainer}>
                <Image source={algooimg} style={styles.imgorgif}/>
            </View>
          </View>
        </View>
      </ImageBackground>
