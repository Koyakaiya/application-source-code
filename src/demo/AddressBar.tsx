...
import dings from '../audio/ADDRESSBAR/ADDRESS1.mp3';
import dings2 from '../audio/ADDRESSBAR/ADDRESS2.mp3';
import dings3 from '../audio/ADDRESSBAR/ADDRESS3.mp3';
import addresbarimg from '../audio/ADDRESSBAR/addressbar.png'
...
export default function AddressBar({ navigation }): JSX.Element {
        ...
        <View style={styles.SBFcontainer}>
          ...
          <View style={styles.audiodetailsContainer}>
            <View style={styles.detailsname}>
              ...
              <Text style={styles.engtranslationtext}>Address Bar</Text>
            </View>
            {/* Audio */}
          ...
          <View style={styles.audiodetailsContainer}>
            <View style={styles.detailsname}>
              ...
              <Text style={styles.engtranslationtext}>Gurbin Adireshi</Text>
            </View>
            {/* Audio */}
            <View style={styles.audioContainer}>
            <TouchableOpacity
          ...
          <View style={styles.explanation}>
            ...
            <View style={styles.description}>
              ...
              Wannan wani gurbi ne da ke samuwa a saman shafin alƙuƙin shiga yanar gizo da ake saka adireshin wani ainihin ɗaki a yanar gizo. 
              </Text>
            </View>
          </View>
          {/* GIF, Images, Video */}
          <View style={styles.givcontainer}>
            ...
            <View style={styles.diagramcontainer}>
                <Image source={addresbarimg} style={styles.imgorgif}/>
            </View>
          </View>
        </View>
      </ImageBackground>
