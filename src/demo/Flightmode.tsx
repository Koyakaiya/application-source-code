...
import dings from '../audio/FLIGHTMODE/FLIGHT1.mp3';
import dings2 from '../audio/FLIGHTMODE/FLIGHT2.mp3';
import dings3 from '../audio/FLIGHTMODE/FLIGHT3.mp3';
import Flightimg from '../audio/FLIGHTMODE/flightmode.jpg'
...
export default function FlightMode({ navigation }): JSX.Element {
        ...
        <View style={styles.SBFcontainer}>
          ...
          <View style={styles.audiodetailsContainer}>
            <View style={styles.detailsname}>
              ...
              <Text style={styles.engtranslationtext}>Flight Mode</Text>
            </View>
            {/* Audio */}
          ...
          <View style={styles.audiodetailsContainer}>
            <View style={styles.detailsname}>
              ...
              <Text style={styles.engtranslationtext}>Yanayi Na Cikin Jirgin Sama</Text>
            </View>
            {/* Audio */}
            <View style={styles.audioContainer}>
            <TouchableOpacity
          ...
          <View style={styles.explanation}>
            ...
            <View style={styles.description}>
              ...
              Wannan shi ne canza yanayin aikin na’urori (wayoyi, kwamfyutar cinya ko ta hannu) su hana duka hanyoyin sadarwa ba tare da an kashe su ba. Idan aka saka na’ura a wannan yanayin, ba za ta iya aika ko karbi saƙo, kira, ko kuma shiga yanar gizo ba.
              </Text>
            </View>
          </View>
          {/* GIF, Images, Video */}
          <View style={styles.givcontainer}>
            ...
            <View style={styles.diagramcontainer}>
                <Image source={Flightimg} style={styles.imgorgif}/>
            </View>
          </View>
        </View>
      </ImageBackground>
