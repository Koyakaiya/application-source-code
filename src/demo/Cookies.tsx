...
import dings from '../audio/COOKIES/COOKIES1.mp3';
import dings2 from '../audio/COOKIES/COOKIES2.mp3';
import dings3 from '../audio/COOKIES/COOKIES3.mp3';
import cookiesimg from '../audio/COOKIES/cookies.png'
...
export default function Cookies({ navigation }): JSX.Element {
        ...
        <View style={styles.SBFcontainer}>
          ...
          <View style={styles.audiodetailsContainer}>
            <View style={styles.detailsname}>
              ...
              <Text style={styles.engtranslationtext}>Cookies</Text>
            </View>
            {/* Audio */}
          ...
          <View style={styles.explanation}>
            ...
            <View style={styles.description}>
              ...
              Waɗannan wasu 'yan na’urori ne da ke samuwa a gida a yanar gizo da ke sa ido a kan masu ziyartar wannan gidan. Idan mutum ya sake ziyartar wannan gidan, Cookies na sanar mai da gidan cewa shi ainihin mutumin ya dawo.
              </Text>
            </View>
          </View>
          {/* GIF, Images, Video */}
          <View style={styles.givcontainer}>
            ...
            <View style={styles.diagramcontainer}>
                <Image source={cookiesimg} style={styles.imgorgif}/>
            </View>
          </View>
        </View>
      </ImageBackground>
