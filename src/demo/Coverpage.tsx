...
import dings from '../audio/COVERPAGE/COVERPAGE1.mp3';
import dings2 from '../audio/COVERPAGE/COVERPAGE2.mp3';
import dings3 from '../audio/COVERPAGE/COVERPAGE3.mp3';
import Coverpageimg from '../audio/COVERPAGE/coverpage.jpg'
...
export default function CoverPage({ navigation }): JSX.Element {
        ...
        <View style={styles.SBFcontainer}>
          ...
          <View style={styles.audiodetailsContainer}>
            <View style={styles.detailsname}>
              ...
              <Text style={styles.engtranslationtext}>Slide</Text>
            </View>
            {/* Audio */}
          ...
          <View style={styles.audiodetailsContainer}>
            <View style={styles.detailsname}>
              ...
              <Text style={styles.engtranslationtext}>Bangon Litaffi</Text>
            </View>
            {/* Audio */}
            <View style={styles.audioContainer}>
            <TouchableOpacity
          ...
          <View style={styles.explanation}>
            ...
            <View style={styles.description}>
              ...
              Wannan shi ne bangon littafi da ke bayyana abinda ke ƙunshe a cikin littafin, ko mujallar. Bangon littafi zai iya kasancewa wanda aka ƙera da manhajar zane a cikin kwamfyuta ko kuma shi ainihin bugagen littafin.
              </Text>
            </View>
          </View>
          {/* GIF, Images, Video */}
          <View style={styles.givcontainer}>
            ...
            <View style={styles.diagramcontainer}>
                <Image source={Coverpageimg} style={styles.imgorgif} />
            </View>
          </View>
        </View>
      </ImageBackground>
