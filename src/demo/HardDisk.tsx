...
import dings from '../audio/Hardisk/HARDDISK1.mp3';
import dings2 from '../audio/Hardisk/HARDDISK2.mp3';
import dings3 from '../audio/Hardisk/HARDDISK3.mp3';
import Harddiskimg from '../audio/Hardisk/Harddiskdrive.jpg' 
...
export default function HardDisk({ navigation }): JSX.Element {
        ...
        <View style={styles.SBFcontainer}>
          ...
          <View style={styles.audiodetailsContainer}>
            <View style={styles.detailsname}>
              ...
              <Text style={styles.engtranslationtext}>Hard Disk Drive</Text>
            </View>
            {/* Audio */}
          ...
          <View style={styles.audiodetailsContainer}>
            <View style={styles.detailsname}>
              ...
              <Text style={styles.engtranslationtext}>Ginshikin Rumbun Ajiya</Text>
            </View>
            {/* Audio */}
            <View style={styles.audioContainer}>
            <TouchableOpacity
          ...
          <View style={styles.givcontainer}>
            ...
            <View style={styles.diagramcontainer}>
                <Image source={Harddiskimg} style={styles.imgorgif}/>
            </View>
          </View>
        </View>
      </ImageBackground>
