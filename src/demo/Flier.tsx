...
import dings from '../audio/FLIER/FLIER1.mp3';
import dings2 from '../audio/FLIER/FLIER2.mp3';
import dings3 from '../audio/FLIER/FLIER3.mp3';
import flyerimg from '../audio/FLIER/flyer.png'
...
export default function Flier({ navigation }): JSX.Element {
        ...
        <View style={styles.SBFcontainer}>
          ...
          <View style={styles.audiodetailsContainer}>
            <View style={styles.detailsname}>
              ...
              <Text style={styles.engtranslationtext}>Flier</Text>
            </View>
            {/* Audio */}
          ...
          <View style={styles.audiodetailsContainer}>
            <View style={styles.detailsname}>
              ...
              <Text style={styles.engtranslationtext}>Karamin Kasida</Text>
            </View>
            {/* Audio */}
            <View style={styles.audioContainer}>
            <TouchableOpacity
          ...
          <View style={styles.givcontainer}>
            ...
            <View style={styles.diagramcontainer}>
                <Image source={flyerimg} style={styles.imgorgif}/>
            </View>
          </View>
        </View>
      </ImageBackground>
